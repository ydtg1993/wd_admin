...
class HomeController
{
    ...
    /**
     * @api {Get} /api/home 获取首页新种信息
     * @apiName 获取首页新种信息
     * @apiGroup 首页相关
     * @apiDescription 获取首页新种信息
     *
     * @apiParam {Number} home_type 首页类型4必须传4
     * @apiParam {Number} is_subtitle 状态：1.不含字幕、2.含字幕
     * @apiParam {Number} is_download 状态：1.不可下载、2.可下载
     * @apiParam {Number} is_short_comment 状态：1.不含短评、2.含短评
     * @apiParam {Number} page 分页页码
    ...
    /**
     * @api {Get} /api/rank 获取影片排行版
     * @apiName 获取影片排行版
     * @apiGroup 排行相关
     * @apiDescription 获取影片排行版
     *
     * @apiParam {Number} type 类别id【0.全部、1.有码、2.无码、3.欧美、10.国产】
     * @apiParam {Number} time 时间戳【例如：2021年5月1日的时间戳是1619798400】时间类型【0.全部、1.日版、2.周榜、3.月榜】
     * @apiParam {Number} page 分页页码
     * @apiParam {Number} pageSize 分页长度
     *
     * @apiSuccess {Number} sum 数据总数
     * @apiSuccess {Object} list 列表【数组】
     * @apiSuccess {Object} list 影片列表
     * @apiSuccess {Number} list.id 影片ID
     * @apiSuccess {Number} list.small_cover 影片缩图
     * @apiSuccess {String} list.big_cove 影片大图
     * @apiSuccess {String} list.release_time 发行时间
     * @apiSuccess {Object} list.is_download 可下载
     * @apiSuccess {String} list.is_subtitle 字幕
     * @apiSuccess {Number} list.comment_num 评论数
     * @apiSuccess {String} list.score 评分
     * @apiSuccess {Number} list.is_flux_linkage 磁链数
     * @apiSuccess {Number} list.rank 排序，从小到大
     *
     */
     ...
     *
     * @apiParam {Number} type 类别id【0.全部、1.有码、2.无码、3.欧美、10.国产】
     * @apiParam {Number} time 时间戳【例如：2021年5月1日的时间戳是1619798400】【备注最好加上】时间类型【0.全部、1.日版、2.周榜、3.月榜】
     * @apiParam {Number} page 分页页码
     * @apiParam {Number} pageSize 分页长度
     *
     * @apiSuccess {Number} sum 数据总数
