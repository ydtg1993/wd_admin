    ...
    <div class="layui-card">
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group ">
                @can('announcement.content.create_content')
                    <a class="layui-btn layui-btn-sm" href="{{ route('admin.content.create_content') }}">添 加</a>
                @endcan
            </div>
        </div>
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="options">
                <div class="layui-btn-group">
                    @can('announcement.content.edit_content')
                        <a class="layui-btn layui-btn-sm" lay-event="edit">编辑</a>
                    @endcan
                    @can('announcement.content.destroy_content')
        ...
        <script>
            layui.use(['layer', 'table', 'form'], function () {
                ...
                var dataTable = table.render({
                    ...
                    , autoSort: false
                    , height: 500
                    , url: "{{ route('admin.top.data') }}"+"?type=2" //数据接口
                    , page: true //开启分页
                    , cols: [[ //表头
