...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form" action="{{route('admin.movie.label.min.edit',['id'=>$label->id])}}" method="post">
                {{ method_field('put') }}
                {{csrf_field()}}
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="sort" lay-verify="required" class="layui-input" value="{{ $label->sort ?? old('sort') }}">
                    </div>
                </div>
