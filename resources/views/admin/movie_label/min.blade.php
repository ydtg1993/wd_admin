    ...
    <div class="layui-card">
                ...
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" id="parent">
                            </div>
                        </div>
        ...
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group">
                <a class="layui-btn layui-btn-sm" href="{{route('admin.movie.label.min.create')}}" >添 加</a>
            </div>
        </div>
        ...
        <script>
            layui.use(['layer', 'table', 'form','laydate'], function () {
                ...
                var dataTable = table.render({
                    ...
                    ,id:'table'
                    , height: 500
                    , url: "{{ route('admin.movie.label.min') }}" //数据接口
                    , method:'POST'
                    , page: true //开启分页
                    , cols: [[ //表头
                        {field: 'id', title: 'ID', sort: true, width: 80}
                        , {field: 'name', title: '名称'}
                        , {field: 'cname', title:'父级标签'}
                        , {field: 'item_num', title:'影片数量'}
