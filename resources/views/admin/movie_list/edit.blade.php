...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form" action="{{route('admin.movie.list.edit',['id'=>$list->id])}}" method="post" enctype="multipart/form-data">
                {{ method_field('post') }}
                {{csrf_field()}}
                <div class="layui-form-item">
                    <label for="" class="layui-form-label">标题</label>
                    <div class="layui-input-inline">
                        <input type="text" name="name" lay-verify="required" placeholder="请输片单名称" value="{{$list->name}}" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="" class="layui-form-label">简介</label>
                    <div class="layui-input-block">
                        <textarea name="intro" placeholder="请输入简介"  class="layui-textarea">{{$list->intro}}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="" class="layui-form-label">创建人</label>
                    <div class="layui-input-block">
                        <input name="uid" placeholder="创建用户id" class="layui-input" value="{{$list->uid}}">
                    </div>
                </div>
