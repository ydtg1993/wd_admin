...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form" action="{{route('admin.movie.movie.addComment')}}" method="post">
                {{ method_field('put') }}
                {{csrf_field()}}
                <div class="layui-form-item">
                    <label for="" class="layui-form-label">番号</label>
                    <div class="layui-input-inline">
                        <input type="text" name="number" lay-verify="required" placeholder="请输入番号" class="layui-input" >
                    </div>
                </div>
