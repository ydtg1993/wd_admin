...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline">
        <input name="email"  placeholder="请输入登录邮箱" class="layui-input" >{{ $userClient->email ?? '' }}</input>
    </div>
</div>

<div class="layui-form-item">
    <label for="" class="layui-form-label">设置密码</label>
    <div class="layui-input-inline">
        <input name="pwd"  type="password" placeholder="请输入设置密码" class="layui-input" >{{ $userClient->pwd ?? '' }}</input>
    </div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline">
        <input type="password" name="pwd_confirmation"  placeholder="请输入确认密码" class="layui-input" ></input>
    </div>
</div>
