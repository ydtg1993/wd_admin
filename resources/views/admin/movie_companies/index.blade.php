    ...
    <div class="layui-card">
        ...
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group">
                <a class="layui-btn layui-btn-sm" href="{{route('admin.movie.companies.create')}}" >添 加</a>
                <a class="layui-btn layui-btn-normal layui-btn-radius" target="_blank" href="{{route('admin.movie.companies.list')}}" style="margin-left: 10px!important;">影片列表</a>
                <a class="layui-btn layui-btn-normal layui-btn-radius" target="_blank" href="{{route('admin.movie.companies.like')}}" style="margin-left: 10px!important;">收藏列表</a>
            </div>
        </div>
        ...
        <script>
            layui.use(['layer', 'table', 'form','laydate'], function () {
                ...
                var dataTable = table.render({
                    ...
                    ,id:'table'
                    , height: 500
                    , url: "{{ route('admin.movie.companies') }}" //数据接口
                    , method:'POST'
                    , page: true //开启分页
                    , cols: [[ //表头
                ...
                table.on('tool(dataTable)', function (obj) { //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if (layEvent === 'edit') {
                        location.href = '/admin/movie/companies/' + data.id + '/edit';
                    }
                });
